...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StepBean stepBean0 = new StepBean("Inicio",-1);
        StepBean stepBean1 = new StepBean("Preparación",1);
        StepBean stepBean2 = new StepBean("En camino",-1);
        StepBean stepBean3 = new StepBean("Finailaido",-1);
